...
tirmizi.urdu = "عمرو بن عاص رضی اللہ عنہ سے روایت ہے کہ نبی اکرم ﷺ نے بڑھاپے کے(سفید) بال اکھیڑ نے سے منع کیا،اور فرمایا ہے:' یہ تو مسلمان کا نور ہے' ۱؎۔امام ترمذی کہتے ہیں:۱-یہ حدیث حسن ہے،۲-عبدالرحمٰن بن حارث اورکئی دیگر لوگوں سے یہ حدیث عمر بن شعیب کے واسطہ سے مروی ہے۔";
tirmizi.hukam = "حسن";
tirmizi.description = ``;