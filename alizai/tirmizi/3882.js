...
tirmizi.urdu = "ام المومنین عائشہ رضی اللہ عنہا کہتی ہیں کہ مجھ سے رسول اللہ ﷺ نے فرمایا:' جبرئیل تمہیں سلام کہہ رہے ہیں تو میں نے عرض کیا: ان پر سلام اور اللہ کی رحمتیں اورا س کی برکتیں ہوں'۔\nامام ترمذی کہتے ہیں: یہ حدیث صحیح ہے۔";
tirmizi.hukam = "صحیح";
tirmizi.description = ``;