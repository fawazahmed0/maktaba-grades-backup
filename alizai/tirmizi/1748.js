...
tirmizi.urdu = "انس رضی اللہ عنہ کہتے ہیں: نبی اکرم ﷺ کی انگوٹھی کا نقش تین سطروں میں تھا'محمد'ایک سطر میں 'رسول' ایک سطرمیں اور'اللہ'ایک سطرمیں۔امام ترمذی کہتے ہیں:۱-محمدبن یحیی نے اپنی روایت میں تین سطروں کا ذکر نہیں کیا ہے،۲-اس باب میں ابن عمر رضی اللہ عنہما سے بھی روایت ہے۔";
tirmizi.hukam = "صحیح";
tirmizi.description = ``;