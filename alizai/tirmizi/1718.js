...
tirmizi.urdu = "سائب بن یزید رضی اللہ عنہ کہتے ہیں کہ جب رسول اللہ ﷺ غزوئہ تبوک سے واپس آئے تولوگ آپ کے استقبال کے لیے ثنیۃ الوداع تک نکلے: میں بھی لوگوں کے ساتھ نکلا حالاں کہ میں کم عمر تھا۔\nامام ترمذی کہتے ہیں: یہ حدیث حسن صحیح ہے۔";
tirmizi.hukam = "صحیح";
tirmizi.description = ``;