...
tirmizi.urdu = "زید بن خالد جہنی رضی اللہ عنہ کہتے ہیں کہ رسول اللہ ﷺ نے فرمایا:' جس نے کسی مجاہد کا سامان سفرتیارکیا حقیقت میں اس نے جہاد کیا اور جس نے غازی کے گھروالے کی خبرگیری کی حقیقت میں اس نے جہادکیا'۔\nامام ترمذی کہتے ہیں: یہ حدیث حسن صحیح ہے۔";
tirmizi.hukam = "صحیح";
tirmizi.description = ``;