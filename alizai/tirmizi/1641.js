...
tirmizi.urdu = "کعب بن مالک رضی اللہ عنہ سے روایت ہے کہ رسول اللہ ﷺ نے فرمایا:' شہداء کی روحیں (جنت میں) سبز پرندوں کی شکل میں ہیں،جو جنت کے پھلوں یا درختوں سے کھاتی چرتی ہیں'۔\nامام ترمذی کہتے ہیں: یہ حدیث حسن صحیح ہے۔";
tirmizi.hukam = "صحیح";
tirmizi.description = ``;